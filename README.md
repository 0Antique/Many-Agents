...
【使用Vibe Coding的一次尝试，发现扑街了；AI对于工程化的实现还是不行；本人编写的提示词不足以支撑AI大发挥出全部的实力；】

大致界面我希望长这样，但是在右侧上方显示各个模型的时候应该是完整功能的对话功能，而不是现在这个样子

1、完善界面

2、逻辑上打通

3、对话中增加多种接口，比如上传图片，上传PDF

![1764662803404](assets/1764662803404.png)
